...
from effdet import create_model, create_evaluator, create_dataset, create_loader, create_xray_dataset
...
def validate(args):
    ...
    dataset = create_xray_dataset(name=args.dataset, root=args.root, fold=args.fold, splits=args.split)
