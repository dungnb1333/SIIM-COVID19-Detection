...
from utils import seed_everything, refine_det, save_dict
...
if __name__ == "__main__":
    output_dir = '{}/{}_{}_fold{}_test_pred'.format(args.output_dir, args.model, args.image_size, '_'.join(str(x) for x in args.folds))
    ...
    for fold in args.folds:
        ...
        CHECKPOINT = '{}/{}_{}_fold{}/model_best.pth.tar'.format(args.ckpt_dir, args.model, args.image_size, fold)
    ...
    dataset = SiimCovidDataset(df=test_df, images_dir=args.image_dir, image_size=args.image_size)
