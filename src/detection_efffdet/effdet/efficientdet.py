...
class EfficientDet(nn.Module):
    ...
    @torch.jit.ignore()
    def reset_head(self, num_classes=None, image_size=None, aspect_ratios=None, num_scales=None, alternate_init=False):
        ...
        if image_size is not None:
            reset_class_head = True
            self.config.image_size = [image_size, image_size]
