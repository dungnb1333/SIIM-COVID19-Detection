...
if __name__ == "__main__":
    ...
    for fold in args.folds:
        ...
        model = SiimCovidAuxModel(
            ...
            model_pretrained_path='rsnapneu_pretrain/{}_{}_rsnapneu.pth'.format(cfg['backbone_name'], cfg['aux_image_size']),
            model_pretrained_cls_num_classes=len(rsnapneumonia_classes))
